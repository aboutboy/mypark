                    ...
                    <div class="tab-container ng-isolate-scope">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="ng-isolate-scope pull-right">
                                <a href="<?= $adminurl ?>class" class="ng-binding">分类管理</a>
                            </li>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                <thead><tr><th>注册商</th><th>所属分类</th><th>简称</th><th>域名</th><th>注册时间</th><th>到期时间</th><th>状态</th><th>操作</th></tr></thead>
                                <tbody>
                                    <?php
                                    foreach ($rows as $res) {
                                        if ($res['status'] == 1) {
                            ...
                            ?>">
                                ...
                                <div class="form-group form-inline">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        到期时间：<input class="form-control" type="text" name="stoptime" value="<?php
                                        if ($_GET['do'] == 'edit') {
                                            echo date('Y-m-d H:i:s', $row['stoptime']);
                                        } else {
                                            echo date('Y-m-d H:i:s');
                                        }
