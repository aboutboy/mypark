            ...
            <header id="header" class="app-header navbar" role="menu"> 
                ...
                <div class="collapse pos-rlt navbar-collapse box-shadow bg-white-only"> 
                    ...
                    <ul class="nav navbar-nav hidden-sm">
                        ...
                        <li class="dropdown"> <a data-toggle="dropdown" class="dropdown-toggle"> <span class="font-bold">快捷操作</span><span class="caret"></span></a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="/<?= $_cp->url()[1] ?>/system"><span><i class="icon-settings icon"></i> 资料设置</span></a></li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown"> 
                            <a href="#" data-toggle="dropdown" class="dropdown-toggle clear" data-toggle="dropdown"><span class="text-muted text-xs"><?= $_SESSION['user'] ?></span>
                            ...
                            <ul class="dropdown-menu animated fadeInRight w">
                                <li> <a href="/<?= $_cp->url()[1] ?>/system"><span>资料设置</span></a> </li>
                                <li class="divider"></li>
                    ...
                    <div class="navi-wrap"> 
                        ...
                        <nav class="navi clearfix">
                            <ul class="nav">
                                ...
                                <li <?php if($_cp->url()[2]=='system'){echo 'class="active"';}?>> <a href="/<?= $_cp->url()[1] ?>/system" target="_self"> <i class="icon-settings icon"></i><span class="font-bold ng-scope">资料设置</span></a></li>
