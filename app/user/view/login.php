...
<html lang="zh-cn" class="app">
    ...
    <body>
            ...
            <div class="modal-center animated fadeInUp text-center" style="width:300px;margin:-100px 0 0 -100px;">
                ...
                <p class="h4 m-t m-b">您好，欢迎登录智能域名停靠系统</p>
                <div class="input-group" onKeyDown = "_b()">
                    <input type="text" name="username" class="form-control text-sm no-border" placeholder="请输入用户名">
                    <input type="password" name="password" class="form-control text-sm no-border" placeholder="请输入解锁密码">
                </div>
                <span class="input-group-btn">
                        <a href="register" class="btn btn-info no-border">注册 <i class="fa fa-arrow-right"></i></a>
                </span>
                <span class="input-group-btn">
                        <a href="javascript:login()" class="btn btn-success no-border">登录 <i class="fa fa-arrow-right"></i></a>
                </span>
            </div>
        </div></div>
