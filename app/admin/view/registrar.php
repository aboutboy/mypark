...
<div id="content" class="app-content" role="main">
    ...
    <div class="app-content-body ">
        ...
        <div class="bg-light lter b-b wrapper-md hidden-print">
            <h1 class="m-n font-thin h3">注册商管理</h1>
        </div>
        <div class="wrapper-md control"><div class="panel panel-default">
                <div class="tab-container ng-isolate-scope">
                    <ul class="nav nav-tabs">
                        ...
                        ?>">
                            <a href="registrar" class="ng-binding">域名注册商</a>
                        </li>
                        <li class="ng-isolate-scope <?php
                        if ($_GET['do'] == null) {
                            echo 'disabled';
                        ...
                        <div class="panel-body">
                            ...
                            ?>">
                                ...
                                <div class="form-group form-inline">
                                    <label class="col-sm-2 control-label">注册商名称</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="name" value="<?= @$row['name'] ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">注册商备注</label>
                                    <div class="col-sm-9">
...
<?php } else { ?>
                <div class="panel-heading font-bold">
                    <a href="?do=add" class="btn btn-sm btn-success btn-addon"><i class="fa fa-plus"></i>添加</a>
                </div>
                <div class="table-responsive">
                    <table class="table table-striped">
                        <thead><tr><th>排序</th><th>分类ID</th><th>域名注册商</th><th>备注描述</th><th>操作</th></tr></thead>
                        <tbody>
                    <?php
